...
-- This migration replaces existing program categories with the new list

-- Delete old program categories (except ERG and categories that exist in new list)
DELETE FROM categories 
WHERE type = 'program' 
AND id NOT IN (
  'erg',  -- Keep ERG
  'leadership',  -- Keep (exists in new list)
  'mentoring-program',  -- Keep (exists in new list)
  'coaching-program'  -- Keep (exists in new list)
);

-- Insert new program categories
